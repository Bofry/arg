...
func TestJsonFloatNumberWithNonNanNorInf_FloatBetweenRange(t *testing.T) {
	{
		var arg json.Number = "1"
		err := JsonNumber(arg, "arg",
			NonNanNorInf, FloatBetweenRange(0, 1.49))
		if err != nil {
			t.Errorf("should not error")
		}
	}
...
func TestNonEmptyArray_WithStringArray(t *testing.T) {
	{
		var arg []string = []string{}
		err := NonEmptyArray(arg, "arg")
		if err == nil {
			t.Errorf("should get error")
		}
	}
	{
		var arg []string = []string{"foo", "bar"}
		err := NonEmptyArray(arg, "arg")
		if err != nil {
			t.Errorf("should not error")
		}
...
func TestNonEmptyArray_WithIntArray(t *testing.T) {
	{
		var arg []int = []int{}
		err := NonEmptyArray(arg, "arg")
		if err == nil {
...
func TestNonEmptyArray_WithObjectArray(t *testing.T) {
	type Model struct {
		Value string
	}
